...
1. Демонстрационный пример по верстке классического лендинга на чистом HTML и CSS
...
6. Традиционный учебный пример на React - TODO - Список текуших дел.
   Реализован на чистом React.[https://arsennyrov.github.io/6_todo/](https://arsennyrov.github.io/6_todo/)

7. Небольшой справочник по сериалу "Игра престолов" - структурирование проекта, взаимодейстпия с сервером, использование регулярного выражения.

8. Проект на React - небольшой справочник по сериалу
   "Звездные войны". Аналогичен примеру 6, но добавляется работа с изображениями.

9. Проект на React по фильмам и сериалам - организация поиска во взамодействии с сервером.
